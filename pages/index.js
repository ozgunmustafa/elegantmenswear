  ...
  return (
    <Layout>
          ...
          <div className="intro-text-area">
            ...
            <div className="row">
              <div className="col-md-6">
                <a href="#" className=" alfa-btn-outline d-inline-block mb-3">
                  TAKIM ELBİSELER
                </a>
              </div>
              <div className="col-md-6">
      ...
      <section className="bg-light py-5 my-4">
        <div className="container d-grid-4">
      ...
      <div className="separator">Diğer Blazer Kombin Seçenekleri</div>
      ...
      <section id="introduce-video" className="introduce-video">
        ...
        <div className="d-grid-2 bg-video-sec">
          <div
            ...
            style={{ backgroundImage: `url('https://images.unsplash.com/photo-1593032465175-481ac7f401a0?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=800&q=80')` }}
          >
            <span>
